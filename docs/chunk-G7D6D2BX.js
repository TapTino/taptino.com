import{h as x}from"./chunk-BJCR4PLT.js";import{a as f}from"./chunk-FP4F3AKD.js";import{Y as u}from"./chunk-AZFJKHKB.js";import"./chunk-543JV44P.js";import{k as d,l as g,o as h}from"./chunk-DFSPCKIU.js";import{Fb as t,Gb as n,Hb as p,Nb as c,Zb as e,dc as l,kb as s,pa as m}from"./chunk-AYJ33JAE.js";var z=(()=>{let i=class i{get route(){return this.router.url.slice(1)}constructor(a,o){this.store$=a,this.router=o}openIssue(){this.store$.dispatch(x({title:"Errore 404 durante la navigazione",body:`Buongiorno,
...
Grazie per il vostro tempo`}))}};i.\u0275fac=function(o){return new(o||i)(s(u),s(d))},i.\u0275cmp=m({type:i,selectors:[["tpt-error"]],standalone:!0,features:[l],decls:21,vars:0,consts:[[1,"error-code"],[1,"error-desc"],[1,"error-details"],[1,"error-actions"],["icon","home","label","Homepage","routerLink",""],["icon","open_in_new","label","Segnala",3,"click"]],template:function(o,_){o&1&&(t(0,"span",0),e(1,"404"),n(),e(2,`
`),t(3,"span",1),e(4,`
...
`),n(),e(13,`
`),t(14,"section",3),e(15,`
  `),p(16,"tpt-button",4),e(17,`
  `),t(18,"tpt-button",5),c("click",function(){return _.openIssue()}),n(),e(19,`
`),n(),e(20,`
`))},dependencies:[h,g,f],styles:["[_nghost-%COMP%]{display:flex;flex-direction:column;align-items:center;gap:2rem;flex:1;height:100%;padding:3rem}[_nghost-%COMP%] > span[_ngcontent-%COMP%]{max-width:46.25rem;text-align:center;line-height:1.5rem;color:#6571a8}[_nghost-%COMP%] > span.error-code[_ngcontent-%COMP%]{font-size:14rem;line-height:13rem;padding:0;font-weight:600;color:#fff;text-shadow:-4px -4px 0 #e87e0c,4px -4px 0 #e87e0c,-4px 4px 0 #e87e0c,4px 4px 0 #e87e0c,0px -4px 0 #e87e0c,0px 4px 0 #e87e0c,-4px 0px 0 #e87e0c,4px 0px 0 #e87e0c}@media (max-width: 31.25rem){[_nghost-%COMP%] > span.error-code[_ngcontent-%COMP%]{font-size:10rem;line-height:9rem}}@media (max-width: 22.5rem){[_nghost-%COMP%] > span.error-code[_ngcontent-%COMP%]{font-size:8rem;line-height:7rem}}[_nghost-%COMP%] > span.error-desc[_ngcontent-%COMP%]{font-weight:200}[_nghost-%COMP%] > span.error-details[_ngcontent-%COMP%]{font-weight:500}@media (max-width: 31.25rem){[_nghost-%COMP%] > span[_ngcontent-%COMP%]{font-size:.75rem;line-height:1.25rem}}[_nghost-%COMP%] > .error-actions[_ngcontent-%COMP%]{display:flex;justify-content:space-between;width:100%;max-width:32rem;margin-top:1rem}@media (max-width: 31.25rem){[_nghost-%COMP%] > .error-actions[_ngcontent-%COMP%]{flex-direction:column;align-items:center;gap:1.25rem;margin-top:0}}"]});let r=i;return r})();export{z as ErrorComponent};
