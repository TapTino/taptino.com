 ...
 * @typedef {PhoneNumberComponent}
 * @extends {TptControlValueAccessor<string>}
 */
@Component({
  selector: 'tpt-phone-number',
  standalone: true,
  imports: [
    FormsModule,
    MatInputModule,
...
export class PhoneNumberComponent extends TptControlValueAccessor<string> implements AfterViewInit {
  /**
   * 
   *
   * @public
